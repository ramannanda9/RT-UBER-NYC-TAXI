...
public class CostEstimate {
  ...
  public boolean equals(Object o) {
    ...
    if (!distanceMiles.equals(that.distanceMiles)) {
      return false;
    }
    if (!journeyDuration.equals(that.journeyDuration)) {
      return false;
    }
    if (maxCostCent != null ? !maxCostCent.equals(that.maxCostCent) : that.maxCostCent != null) {
      return false;
    }
    if (minCostCent != null ? !minCostCent.equals(that.minCostCent) : that.minCostCent != null) {
      return false;
    }
    if (primeTimeConfirmationToken != null ? !primeTimeConfirmationToken
        .equals(that.primeTimeConfirmationToken) : that.primeTimeConfirmationToken != null) {
      return false;
    }
    if (!primeTimePercentage.equals(that.primeTimePercentage)) {
      return false;
    }
    if (!rideType.equals(that.rideType)) {
      return false;
    }
  ...
  public int hashCode() {
    ...
    result =
        31 * result + (primeTimeConfirmationToken != null ? primeTimeConfirmationToken.hashCode()
            : 0);
