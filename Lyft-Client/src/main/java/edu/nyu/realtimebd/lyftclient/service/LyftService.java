 ...
 * The LyftService Retrofit class maps to the Lyft REST API
 */
...
public interface LyftService {
    ...
    @POST("oauth/token")
    public Call<OAuthResponse> getAccessToken(@Body OAuthRequest request);

    @GET("v1/cost")
    public Call<CostEstimates> getCostEstimates(@Query("start_lat") Float startLatitude,
