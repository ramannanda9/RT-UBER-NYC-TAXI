...
/**
 * Created by Ramandeep Singh on 11-04-2016. This class contains the attributes that are returned by
 * price endpoint of Uber API
 *
...
public class Price {
  ...
  public boolean equals(Object o) {
    ...
    if (!displayName.equals(price.displayName)) {
      return false;
    }
    if (!distance.equals(price.distance)) {
      return false;
    }
    if (!highEstimate.equals(price.highEstimate)) {
      return false;
    }
    if (!localizedDisplayName.equals(price.localizedDisplayName)) {
      return false;
    }
    if (!lowEstimate.equals(price.lowEstimate)) {
      return false;
    }
    if (!minimumFare.equals(price.minimumFare)) {
      return false;
    }
    if (!productId.equals(price.productId)) {
      return false;
    }
    if (!surgeMultiplier.equals(price.surgeMultiplier)) {
      return false;
    }
